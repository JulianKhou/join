      ...
      <form class="edit-task-form" id="editTaskForm-${task.id}">
        ...
        <div class="edit-form-group">
          ...
          <input type="text" id="editTaskTitle-${
            task.id
          }" class="edit-form-input" value="${task.title}" required>
        </div>
        ...
        <div class="edit-form-group">
          ...
          <textarea id="editTaskDescription-${
            task.id
          }" class="edit-form-textarea">${task.description}</textarea>
        </div>
        ...
        <div class="edit-form-group">
          ...
          <input type="date" id="editTaskDate-${
            task.id
          }" class="edit-form-input" value="${task.dueDate}">
        </div>

        <!-- Hidden category field to preserve original category -->
        <input type="hidden" id="editTaskCategory-${task.id}" value="${
    task.category || "No Category"
        ...
        <div class="edit-form-group">
          ...
          <div class="edit-priority-group">
            <button type="button" class="edit-priority-btn" id="edit-priority-urgent-${
              task.id
            ...
            <button type="button" class="edit-priority-btn" id="edit-priority-medium-${
              task.id
            ...
            <button type="button" class="edit-priority-btn" id="edit-priority-low-${
              task.id
            }" data-priority="Low">
      ...
      <div class="edit-overlay-actions">
        <button type="submit" form="editTaskForm-${
          task.id
        }" class="edit-btn-ok" id="editBtnOk-${task.id}">Ok
