export function taskCardTemplate(tasks) {
  ...
  let taskCards = ` 
    ...
    <div class="task-card grabbable" id="task-card-${
      tasks.id
    }" draggable="true">
          <div class="tasks-card-content">
            ...
            <div class="task-priority">
                <svg class="priority-icon priority-${(
                  tasks.priority || "medium"
                ).toLowerCase()} " xmlns="http://www.w3.org/2000/svg" width="17" height="7"
...
export function addSubtaskToDetailTemplate(text, completed = false, index) {
  return `
    <div class="overlay-subtask-item" onclick="toggleSubtask(${index})">
      <div class="custom-checkbox ${completed ? "checked" : ""}">
          ${
            completed
